...
```{R}
# Read data file
agaricus_lepiota <- read.table("C:\\Users\\Randi Skrelja\\Documents\\EDUCATION\\CUNY\\Refreshers\\R\\Week 3\\data\\agaricus-lepiota.data", header=FALSE, sep=",")

# Read Data Dictionary
Data_Dict <- read.csv("C:\\Users\\Randi Skrelja\\Documents\\EDUCATION\\CUNY\\Refreshers\\R\\Week 3\\data\\Mushrooms_Data_Dictionary.csv")
